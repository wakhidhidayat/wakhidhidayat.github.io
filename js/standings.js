  ...
  data.standings.forEach(klasemen => {
    ...
    klasemen.table.forEach(club => {
      ...
      dataTabelKlasemen += `<tr>
        ...
        <img class = "show-on-medium-and-up show-on-medium-and-down" src=${club.team.crestUrl}  alt="logo club" style="float:left;width:30px;height:30px;margin-right:20px">
        ${club.team.name}
        </p>
        <p class="hide-on-med-and-up">
        <img src=${club.team.crestUrl}  alt="logo club" style="float:left;width:22px;height:22px;margin-right:20px;"> <br/>
        </p>
